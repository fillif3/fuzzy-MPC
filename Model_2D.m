...
state(3) = 0.25*time_step^2*(input(2)-input(1))+0.5*(current_state(5)-current_state(4))*time_step+current_state(3);
state(1) = (0.25*time_step^2*(input(2)+input(1))+0.5*(current_state(5)+...
    current_state(4))*time_step)*cos(0.5*(current_state(3)+state(3)))+current_state(1);
state(2) = (0.25*time_step^2*(input(2)+input(1))+0.5*(current_state(5)+...
